...
async function main() {
    ...
    const url = new URL(
           params.get("url") || "counter.json",
        "https://huggingface.co/datasets/mobile-gs2/mobile-gs2/resolve/main/",
        // "comp.json",
        // location.href,
    );
    // const url = new URL('/models/counter.json', window.location.origin).href;
    ...
    const tmc3Path = new URL('/tools/tmc3.js', window.location.origin).href;
